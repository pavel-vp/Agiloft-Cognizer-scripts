...
public class CognizerIngestContractCreateRequest extends CognizerIngestRequest {
  private final String filePath;
  private final Long eventCreatedTimestamp;
  private final Set<String> aclList;

  public CognizerIngestContractCreateRequest(ContractDataWithACL contractDataWithACL, String orgId, String contractId, String filePath, Long eventCreatedTimestamp, Set<String> aclList) {
  ...
  public String toString() {
    return "CognizerIngestContractCreateRequest{" +
      "orgId='" + orgId + '\'' +
